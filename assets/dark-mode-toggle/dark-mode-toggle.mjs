...
export class DarkModeToggle extends HTMLElement {
  ...
  connectedCallback() {
    ...
    if (e) {
      matchMedia(o).addListener(({ matches: e }) => {
        if (this.permanent) {
          return;
        }
        this.mode = e ? r : s;
  ...
  R(e, t) {
    this.dispatchEvent(
      new CustomEvent(e, { bubbles: true, composed: true, detail: t })
    );
  }
  _() {
  ...
  l() {
    if (this.mode === s) {
      this.$.style.setProperty(
        `--${$}-checkbox-icon`,
        `var(--${$}-light-icon,url("${Li}moon.png"))`
      );
