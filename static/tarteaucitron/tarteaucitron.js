...
var tarteaucitron = {
    ...
    "load": function () {
        ...
        var cdn = tarteaucitron.cdn,
            ...
            pathToLang = cdn + 'tarteaucitron/lang/tarteaucitron.' + language + (useJSDelivrMinifiedJS ? '.min' : '') + '.js?v=' + tarteaucitron.version,
            pathToServices = cdn + 'tarteaucitron/tarteaucitron.services' + (useJSDelivrMinifiedJS ? '.min' : '') + '.js?v=' + tarteaucitron.version,
        ...
        if ( !tarteaucitron.parameters.useExternalCss ) {
            ...
            linkElement.href = cdn + 'tarteaucitron/css/tarteaucitron' + (useJSDelivrMinifiedJS ? '.min' : '') + '.css?v=' + tarteaucitron.version;
